...
**轻量级 GeoJSON 地图编辑器**，专注核心地图编辑功能，基于 Leaflet 构建，支持高级图层管理、时间轴快照、组合标记、框选操作等功能。

### 📦 与完整版的区别

本项目是 [Geomap-app](https://github.com/Superhedgehoger/Geomap-app) 的精简版本：
...
- ✅ 轻量级部署环境
- ✅ 嵌入其他系统
- ❌ 需要事件追踪功能 → 请使用[完整版](https://github.com/Superhedgehoger/Geomap-app)
...
> **注意**：Lite 版本不包含 `event-tracker.js` 和相关 UI 模块。
