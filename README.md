# GeoJSON 地图编辑器 (Lite 版) - 使用指南

[![Version](https://img.shields.io/badge/version-v2.4.0--lite-green.svg)](CHANGELOG.md)

> ⚠️ **隐私声明**：本项目不包含任何真实或测试业务数据，仅提供代码结构与功能实现。

> 📢 **Lite 版本说明**：本版本为轻量版，**永久不包含事件追踪器功能**。如需完整功能，请使用 [Geomap-app](https://github.com/Superhedgehoger/Geomap-app) 主仓库。

## 🎉 功能概览

功能完整的 **GeoJSON 编辑器**，类似 geojson.io！（不含事件追踪器）
